(function() {
    ...
    function saveTask(event) {
      ...
      var task = {
        taskId: lastId,
        taskDes: document.getElementById("descricao").value,
        taskNom: document.getElementById("nome").value,
    ...
    function updateTask(event) {
      ...
      if (!!taskToUpdate) {
        var nom = prompt("Task Name", taskToUpdate.taskNom);
